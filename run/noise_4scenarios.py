...
if __name__ == '__main__':
    ...
    log_dir='C:/Users/INDA_HIWI/Desktop/plot_oc_flickr_train_ae/4_scenarios_training/val'
    ...
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr18_18_epoch13.pth'
    ...
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr12_12_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    #
    # print('training with snr 6')
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr6_6_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    #
    # print('training with snr 0')
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr0_0_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    #
    # print('training with snr -6')
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr-6_-6_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    #
    # print('training with snr -12')
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr-12_-12_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    #
    # print('training with snr -18')
    # load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/ckpt/256_256/snr-18_-18_epoch13.pth'
    # val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
    ...
    print('training snr None, batch size 500')
    load_ckpt_path = 'C:/Users/INDA_HIWI/Desktop/plot_oc_flickr_train_ae/4_scenarios_training/ckpts/batchsize500/snrNone_None_epoch14.pth'
    val(ret_ats=ret_ats, channel_snrs=channel_snrs, out_feature_dims=out_feature_dims, log_dir=log_dir, load_ckpt_path=load_ckpt_path, seeds=seeds)
