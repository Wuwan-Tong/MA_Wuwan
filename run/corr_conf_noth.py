...
def train(ret_ats,
    ...
    val_dataset = Flickr30kDatasetConfRandNcaps(img_dir=dataset_cfg.img_dir, ann_file=dataset_cfg.annotations_path_test, preprocess=preprocess, cap_num=cap_num)
...
if __name__ == '__main__':
    ...
    # choose dataset
    dataset_cfg = Flickr30kCfgCorrConfNoth  # Flickr30kCfgConfusionInfo, Flickr30kCfgRandErrInfo, Flickr30kCfgErrorInfo
    seeds = [1234, 2345, 3456, 4567, 5678]
    ...
    log_dir = 'C:/Users/INDA_HIWI/Desktop/logs_fix_val_noise/confusion_error_compare'  # dataset_cfg.log_dir #'C:/Users/INDA_HIWI/Desktop/plot_oc_flickr_noae_notrain/ds_image'
