...
if __name__=='__main__':
    ...
    #     ri_opt, rc_opt, ni_opt, nc_opt, acc_opt, acc_gt, acc_diff = opt_num_res_intp_4D(acc_ori, snr_img, snr_cap, numsym_img, numsym_cap, step_num_snr, step_num_numsym, ri_init, rc_init, res_total, channel_snr, max_n)
    ...
    # ############################################ opt 4D numsym res
    # total_res_range = np.arange(11, 17, 1)
    # opt_acc_totalres = {}
    # for ic in ['img', 'cap']:
    #     for r in [1, 5, 10]:
    #         opt_acc_totalres[f'{ic}ret_r{r}'] = np.zeros(total_res_range.shape)
